...
//const getPolicies = require('./utils/utils.js')
//const getProducts = require('./utils/utils.js')
...
function getPolicies() {
  let policies = fs.readFileSync('./utils/policies.json')
